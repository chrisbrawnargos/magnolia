    ...
    public TravelDemoMultiSiteModuleVersionHandler() {
        register(DeltaBuilder.update("1.1.3", "")
                ...
                .addTask(new IsInstallSamplesTask("Re-Bootstrap website content for sportstation pages", "Re-bootstrap website content to account for all changes",
                        new BootstrapSingleResource("", "", "/mgnl-bootstrap-samples/travel-demo-multisite/website.sportstation.yaml", ImportUUIDBehavior.IMPORT_UUID_COLLISION_REPLACE_EXISTING)))
